/* eslint-disable */
// @see: https://raw.githubusercontent.com/miroapp/web-plugins/master/rtb.d.ts
declare module "miro-sdk" {
  export declare namespace SDK {
    ...
    interface IBoardWidgetsCommands {
      ...
      create(
        widgets: { type: string; [index: string]: any }[]
      ...
      //requires 'EDIT_CONTENT' permission
      update(
        widgets: { id: string; [index: string]: any }[]
