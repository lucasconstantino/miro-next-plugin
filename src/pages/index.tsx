...
const Page = () => {
      ...
      miro.initialize({
        extensionPoints: {
          exportMenu: {
            ...
            svgIcon: icon24,
            onClick: () => miro.board.ui.openModal(getPath('modal'))
          },
          toolbar: {
            ...
            onClick: () =>
              miro.board.ui.openLibrary(getPath('library'), {
                title: 'Boilerplate'
              })
          },
          bottomBar: {
            ...
            svgIcon: icon24,
            onClick: () => miro.board.ui.openLeftSidebar(getPath('sidebar'))
          }
        }
      })
    }
  ...
  // no need to render on main entrypoiny.
  return null
}
